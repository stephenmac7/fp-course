...
moveLeft (ListZipper (l :. ls) x rs) = IsZ $
...
moveRight (ListZipper ls x (r :. rs)) = IsZ $
...
swapLeft (ListZipper (l :. ls) x rs) = IsZ $
  ListZipper (x :. ls) l rs
...
swapRight (ListZipper ls x (r :. rs)) = IsZ $
  ListZipper ls r (x :. rs)
